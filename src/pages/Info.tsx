  ...
  return (
    <div className="space-y-4 max-w-2xl">
      ...
      <p className="text-ink-soft">
        ...
        die kameralen Haushaltspläne mit zwei Teilen: dem <b>Verwaltungshaushalt</b> (laufender
        Betrieb) und dem <b>Vermögenshaushalt</b> (Investitionen).
      </p>
      <p className="text-ink-soft">
        Für jedes Jahr gibt es einen <b>Ansatz</b> (Plan) und ein bis zwei Jahre später ein{" "}
        <b>Ergebnis</b> (Ist). Für das laufende Jahr gibt es nur den Plan.
      </p>
